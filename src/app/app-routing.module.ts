...
const routes: Routes = [
  ...
  {path: 'redirect/:link', component:RedirectComponent},
  {path: 'url/:id', component:UrlComponent, canActivate:[AuthenticationGuard]},
  {path: 'urls', component:UrlsComponent,canActivate:[AuthenticationGuard]},
  {path: 'urls/new', component:NewurlComponent,canActivate:[AuthenticationGuard]},
